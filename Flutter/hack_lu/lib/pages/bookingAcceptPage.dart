...
class BookingAcceptPage extends StatefulWidget {
  ...
  //final token;
  @override
  State<BookingAcceptPage> createState() => _BookingAcceptPageState();
}

class _BookingAcceptPageState extends State<BookingAcceptPage> {
              ...
              child: SingleChildScrollView(
                child: requestLists.length == 0
                    ? Column(
                        ...
                        children: [
                          Center(
                            child: 'No Bookings yet!'.text.bold.size(20).make(),
                          ),
